...
- Replace all occurrences of "App" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `App` means the name of the project, while `app` is used in file names.
  - Remember to rename the `include/app` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
